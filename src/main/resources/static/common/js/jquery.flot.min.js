...
!function (a) {
    ...
    function Q(t, i) {
        ...
        this.element = e;
        var o = this.context = e.getContext("2d"), n = window.devicePixelRatio || 1,
    ...
    function o(x, t, i, o) {
        var C = [], S = {
                ...
                hooks: {}
            }, d = null, e = null, h = null, y = null, c = null, p = [], m = [], w = {left: 0, right: 0, top: 0, bottom: 0},
            M = 0, T = 0, W = {
                processOptions: [],
                processRawData: [],
                processDatapoints: [],
        ...
        function n(t) {
            C = function (t) {
                ...
                var t, i = C.length, e = -1;
                for (t = 0; t < C.length; ++t) {
                    var o = C[t].color;
                    null != o && (i--, "number" == typeof o && e < o && (e = o))
                }
                i <= e && (i = e + 1);
                var n, a = [], r = S.colors, l = r.length, s = 0;
                ...
                var t, i, e, o, n, a, r, l, s, c, h, f, u = Number.POSITIVE_INFINITY, d = Number.NEGATIVE_INFINITY,
                    p = Number.MAX_VALUE;
                ...
                }), t = 0; t < C.length; ++t) (n = C[t]).datapoints = {points: []}, I(W.processRawData, [n, n.data, n.datapoints]);
                for (t = 0; t < C.length; ++t) {
                    if (n = C[t], h = n.data, !(f = n.datapoints.format)) {
                        if ((f = []).push({x: !0, number: !0, required: !0}), f.push({
                            y: !0,
                            number: !0,
                            required: !0
                    ...
                    if (null == n.datapoints.pointsize) {
                        ...
                        for (n.xaxis.used = n.yaxis.used = !0, i = e = 0; i < h.length; ++i, e += r) {
                            var b = null == (c = h[i]);
                            if (!b) for (o = 0; o < r; ++o) l = c[o], (s = f[o]) && (s.number && null != l && (l = +l, isNaN(l) ? l = null : l == 1 / 0 ? l = p : l == -1 / 0 && (l = -p)), null == l && (s.required && (b = !0), null != s.defaultValue && (l = s.defaultValue))), a[e + o] = l;
                            if (b) for (o = 0; o < r; ++o) null != (l = a[e + o]) && !1 !== (s = f[o]).autoscale && (s.x && m(n.xaxis, l, l), s.y && m(n.yaxis, l, l)), a[e + o] = null; else if (g && 0 < e && null != a[e - r] && a[e - r] != a[e] && a[e - r + 1] != a[e + 1]) {
                ...
                for (t = 0; t < C.length; ++t) {
                    ...
                    var v = u, k = u, y = d, w = d;
                    for (i = 0; i < a.length; i += r) if (null != a[i]) for (o = 0; o < r; ++o) l = a[i + o], (s = f[o]) && !1 !== s.autoscale && l != p && l != -p && (s.x && (l < v && (v = l), y < l && (y = l)), s.y && (l < k && (k = l), w < l && (w = l)));
                    if (n.bars.show) {
                        var M;
                        switch (n.bars.align) {
                            case"left":
        ...
        function r(e) {
            var t = e.labelWidth, i = e.labelHeight, o = e.options.position, n = "x" === e.direction,
                a = e.options.tickLength, r = S.grid.axisMargin, l = S.grid.labelMargin, s = !0, c = !0, h = !0, f = !1;
        ...
        function l() {
            ...
            if (q.each(i, function (t, i) {
                var e = i.options;
                i.show = null == e.show ? i.used : e.show, i.reserveSpace = null == e.reserveSpace ? i.show : e.reserveSpace, function (t) {
                    var i = t.options, e = +(null != i.min ? i.min : t.datamin),
                        o = +(null != i.max ? i.max : t.datamax), n = o - e;
                    if (0 == n) {
                        var a = 0 == o ? 1 : .01;
                ...
                for (q.each(a, function (t, i) {
                    ...
                    !function (t) {
                        ...
                        var o = (t.max - t.min) / i, n = -Math.floor(Math.log(o) / Math.LN10), a = e.tickDecimals;
                        null != a && a < n && (n = a);
                        var r, l = Math.pow(10, -n), s = o / l;
                    ...
                    }(i), o = (e = i).ticks, e.options.autoscaleMargin && 0 < o.length && (null == e.options.min && (e.min = Math.min(e.min, o[0].v)), null == e.options.max && 1 < o.length && (e.max = Math.max(e.max, o[o.length - 1].v))), function (t) {
                ...
                !function () {
                    ...
                    if (null == i) for (t = i = 0; t < C.length; ++t) i = Math.max(i, 2 * (C[t].points.radius + C[t].points.lineWidth / 2));
            ...
            M = d.width - w.left - w.right, T = d.height - w.bottom - w.top, q.each(i, function (t, i) {
                ...
                var e, o, n, a, r, l = i.box, s = i.direction + "Axis " + i.direction + i.n + "Axis",
                    c = "flot-" + i.direction + "-axis flot-" + i.direction + i.n + "-axis " + s,
                    h = i.options.font || "flot-tick-label tickLabel";
                if (d.removeText(c), i.show && 0 != i.ticks.length) for (var f = 0; f < i.ticks.length; ++f) !(e = i.ticks[f]).label || e.v < i.min || e.v > i.max || ("x" == i.direction ? (a = "center", o = w.left + i.p2c(e.v), "bottom" == i.position ? n = l.top + l.padding : (n = l.top + l.height - l.padding, r = "bottom")) : (r = "middle", n = w.top + i.p2c(e.v), "left" == i.position ? (o = l.left + l.width - l.padding, a = "right") : o = l.left + l.padding), d.addText(c, o, n, e.label, h, null, null, a, r))
            }), function () {
                ...
                if (S.legend.sorted) if (q.isFunction(S.legend.sorted)) o.sort(S.legend.sorted); else if ("reverse" == S.legend.sorted) o.reverse(); else {
                ...
                if (null != S.legend.container) q(S.legend.container).html(c); else {
                    var h = "", f = S.legend.position, u = S.legend.margin;
        ...
        function F(t, i) {
            for (var e, o, n, a, r = A(), l = 0; l < r.length; ++l) if ((e = r[l]).direction == i && (t[a = i + e.n + "axis"] || 1 != e.n || (a = i + "axis"), t[a])) {
                o = t[a].from, n = t[a].to;
                break
            }
        ...
        function u() {
            ...
            if (n) for (q.isFunction(n) && ((i = z.getAxes()).xmin = i.xaxis.min, i.xmax = i.xaxis.max, i.ymin = i.yaxis.min, i.ymax = i.yaxis.max, n = n(i)), t = 0; t < n.length; ++t) {
                var a = n[t], r = F(a, "x"), l = F(a, "y");
                if (null == r.from && (r.from = r.axis.min), null == r.to && (r.to = r.axis.max), null == l.from && (l.from = l.axis.min), null == l.to && (l.to = l.axis.max), !(r.to < r.axis.min || r.from > r.axis.max || l.to < l.axis.min || l.from > l.axis.max)) {
                    ...
                    var s = r.from === r.to, c = l.from === l.to;
                    if (!s || !c) if (r.from = Math.floor(r.axis.p2c(r.from)), r.to = Math.floor(r.axis.p2c(r.to)), l.from = Math.floor(l.axis.p2c(l.from)), l.to = Math.floor(l.axis.p2c(l.to)), s || c) {
                        var h = a.lineWidth || S.grid.markingsLineWidth, f = h % 2 ? .5 : 0;
            ...
            for (var u = 0; u < i.length; ++u) {
                var d, p, m, x, g = i[u], b = g.box, v = g.tickLength;
        ...
        function v(t) {
            t.lines.show && function (t) {
                ...
                a && (y.fillStyle = a, function (t, i, e) {
                    var o = t.points, n = t.pointsize, a = Math.min(Math.max(0, e.min), e.max), r = 0, l = !1, s = 1,
                        c = 0, h = 0;
                    for (; !(0 < n && r > o.length + n);) {
                        ...
                        if (null != f && null != d) {
                            ...
                            if (l || (y.beginPath(), y.moveTo(i.p2c(f), e.p2c(a)), l = !0), u >= e.max && p >= e.max) y.lineTo(i.p2c(f), e.p2c(e.max)), y.lineTo(i.p2c(d), e.p2c(e.max)); else if (u <= e.min && p <= e.min) y.lineTo(i.p2c(f), e.p2c(e.min)), y.lineTo(i.p2c(d), e.p2c(e.min)); else {
                                var m = f, x = d;
        ...
        z.setData = n, z.setupGrid = l, z.draw = s, z.getPlaceholder = function () {
            ...
            var i, e, o, n = {};
            for (i = 0; i < p.length; ++i) if ((e = p[i]) && e.used && (o = "x" + e.n, null == t[o] && 1 == e.n && (o = "x"), null != t[o])) {
                n.left = e.p2c(t[o]);
                break
            }
            for (i = 0; i < m.length; ++i) if ((e = m[i]) && e.used && (o = "y" + e.n, null == t[o] && 1 == e.n && (o = "y"), null != t[o])) {
                n.top = e.p2c(t[o]);
                break
            }
            return n
            ...
            var i, e, o, n = x.css("font-size"), a = n ? +n.replace("px", "") : 13, r = {
        ...
        function H(t, i, e) {
            var o = h.offset(), n = i.pageX - o.left - w.left, a = i.pageY - o.top - w.top, r = f({left: n, top: a});
            r.pageX = i.pageX, r.pageY = i.pageY;
            var l = function (t, i, e) {
                var o, n, a, r = S.grid.mouseActiveRadius, l = r * r + 1, s = null;
                for (o = C.length - 1; 0 <= o; --o) if (e(C[o])) {
                    var c = C[o], h = c.xaxis, f = c.yaxis, u = c.datapoints.points, d = h.c2p(t), p = f.c2p(i),
                        m = r / h.scale, x = r / f.scale;
        ...
        function B(t, i, e) {
            ...
            var n = _(t, i);
            -1 == n ? (N.push({series: t, point: i, auto: e}), j()) : e || (N[n].auto = !1)
        }
        ...
        function V(t, i) {
            var e = i[0], o = i[1], n = t.xaxis, a = t.yaxis,
        ...
        function X(t, i) {
            var e,
                o = "string" == typeof t.highlightColor ? t.highlightColor : q.color.parse(t.color).scale("a", .5).toString(),
                n = o;
            switch (t.bars.align) {
                case"left":
                    e = 0;
    ...
    q.fn.detach || (q.fn.detach = function () {
        ...
        for (var i in t) if (d.call(t, i)) {
            var e = this.getTextLayer(i), o = t[i];
            for (var n in e.hide(), o) if (d.call(o, n)) {
                var a = o[n];
                for (var r in a) if (d.call(a, r)) {
        ...
        if (null == o) {
            ...
            if (null != r) for (var l in r) if (d.call(r, l)) {
                var s = r[l];
                for (var c in s) if (d.call(s, c)) for (var h = s[c].positions, f = 0; u = h[f]; f++) u.active = !1
            }
        } else {
            var u;
