...
!function (t, s) {
    ...
    return n.plugins = n.plugins || {}, n.plugins.legend = function (u) {
        ...
        return u = n.extend({}, t, u), e && (u.position = e), function (l) {
            var e = l.container.querySelector(".ct-legend");
            if (e && e.parentNode.removeChild(e), u.clickable) {
                var t = l.data.series.map(function (e, t) {
                    return "object" != typeof e && (e = {value: e}), e.className = e.className || l.options.classNames.series + "-" + n.alphaNumerate(t), e
                });
                l.data.series = t
            }
            var o = document.createElement("ul"), s = l instanceof n.Pie;
            ...
            var r = [], c = l.data.series.slice(0), i = l.data.series, d = s && l.data.labels && l.data.labels.length;
            if (d) {
            ...
            i.forEach(function (e, t) {
                ...
                if (u.position instanceof HTMLElement) u.position.insertBefore(o, null); else switch (u.position) {
                    case"top":
                ...
                if (t.parentNode === o && t.hasAttribute("data-legend")) {
                    e.preventDefault();
                    var s = parseInt(t.getAttribute("data-legend")), i = r.indexOf(s);
                    if (-1 < i) r.splice(i, 1), t.classList.remove("inactive"); else if (u.removeAll) r.push(s), t.classList.add("inactive"); else if (1 < l.data.series.length) r.push(s), t.classList.add("inactive"); else r = [], Array.prototype.slice.call(o.childNodes).forEach(function (e) {
